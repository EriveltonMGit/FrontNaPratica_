...
export default function Page_1() {
  ...
  return (
    <section className="section_1" id="inicio" data-aos="zoom-out" data-aos-duration="2000">
      {/* CARD 1 */}
      <main className="card_1">
        <h1 className="title_ area-especial text_1">
          {" "}
         FULL DEV, Construindo o Futuro, Hoje
        </h1>
        <div className="mini_cards ">
          <div className="card_ ">
            <h3>
            Ferramentas, aprendizado e uma comunidade para impulsionar sua carreira na tecnologia.
            </h3>
            <p>
            Conecte-se, inove e leve suas habilidades ao próximo nível.
            </p>
            {/* <p>
