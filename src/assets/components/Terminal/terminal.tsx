          ...
          <div className="terminal">
            <hgroup className="head">
              <p className="title">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  strokeLinejoin="round" // Correção aqui
                  strokeLinecap="round"   // Correção aqui
                  strokeWidth="2"         // Correção aqui
                  stroke="currentColor"
                  fill="none"
                >
                  <path
            ...
            <div className="body">
              <pre className="pre">
                <code>-&nbsp;</code>
                <code>npx&nbsp;</code>
                <code className="cmd" data-cmd="create-react-app@latest"></code>
              </pre>
            </div>
            {/* <div className="body">
              <pre className="pre">
                <code>-&nbsp;</code>
                <code>npx&nbsp;</code>
                <code className="cmd" data-cmd="create-next-app@latest"></code>
              </pre>
            </div> */}
          </div>
        </div>
